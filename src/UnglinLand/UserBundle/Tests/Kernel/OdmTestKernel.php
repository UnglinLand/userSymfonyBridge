 ...
 * ODM test kernel
 *
 * This class is used to load the minimum requirements of the UnglinLandUserBundle with odm driver
 *
 ...
 * @link     http://cscfa.fr
 */
class OdmTestKernel extends AbstractKernel
{
    /**
    ...
    {
        return __DIR__.'/../KernelConfig/config_odm.yml';
    }
